(function () {
...
})().directive('customUpload2', function() {
    return {
      controllerAs: 'ctrl',
  ...
  $scope.$watch(function(){return $scope.properties.value;}, function(newValue){
    if (newValue && newValue.filename) {
      ...
      $scope.properties.value.descripcion   = ctrl.old_description;  
      $scope.properties.value.tipoDocumento = ctrl.old_type;
      $scope.properties.value.grupoTipo = ctrl.old_group;
  ...
  function clear() {
    ctrl.old_description = $scope.properties.value.descripcion;  
    ctrl.old_type        = $scope.properties.value.tipoDocumento;
    ctrl.old_group       = $scope.properties.value.grupoTipo;
    ctrl.filename = '';
    ctrl.filemodel = '';
    ...
    $scope.properties.value.tipoDocumento = ctrl.old_type;
    $scope.properties.value.grupoTipo = ctrl.old_group;
    //alert(JSON.stringify($scope.properties.value));
  }
  ...
  function startUploading() {
    ...
    ctrl.old_type        = $scope.properties.value.tipoDocumento;
    ctrl.old_group       = $scope.properties.value.grupoTipo;
   // alert(JSON.stringify(ctrl.old_group));
    ctrl.filemodel = '';
